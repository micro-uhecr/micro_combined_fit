...
@jit
def Distr_Minimization(parms, args, w_zR,w_zR_p):
    ...
    xmax = args[5]
    E_th = args[6]
    exp_distributions_x= args[7]
    exp_distributions_y= args[8]
...
def Minimize_Spectrum_And_Distribution(parms, args, verbose = True):
    ...
    Dev_distributions = Distr_Minimization(parms, args, w_zR, w_zR_p)
