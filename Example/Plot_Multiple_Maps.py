...
if __name__ == "__main__":
	...
	NMaps = 10
	galCoord = False
	folder = "/projet/auger/marafico/CC/micro/Results_SFRD/SFRD_TALYS_LogEmin_19.6_k_1e-08_radius_12_B_LGMF_nG_25_B_IGMF_nG_0.0001_smoothing_fisher_GC_False_fluxmin_0.0/"
	...
	map.PlotHPmap(selected_Flux_map, nside, galCoord, title, color_bar_title, ax_title, fig_name, plot_zoa=False, write=False, cmap='afmhot', vmin=-1, vmax=-1)
