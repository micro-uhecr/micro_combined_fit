...
if __name__ == "__main__":
    ...
    bnds_shiftXmax_logRcut_gammanucl_gammap = ( (-5,5), (18., 19.), (-4, 4), (-5, 5))
    ...
    args = [[Tensor, ts.A, ts.Z, t_EJ,t_EJp,xmax, logE_th,arr_reduced,exp_distribution_reduced,convoluted_gumbel, S_z]] # fit Xmax distr
